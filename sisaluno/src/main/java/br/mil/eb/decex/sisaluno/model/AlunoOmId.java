...
@Embeddable
public class AlunoOmId implements Serializable {
...
//   
	...
	@Override
	public int hashCode() {
		return Objects.hash(codigoAno, aluno, om);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlunoOmId other = (AlunoOmId) obj;
		return Objects.equals(codigoAno, other.codigoAno) && Objects.equals(aluno, other.aluno)
